 ...
 */
function dolphin_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'dolphin_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.dolphin-front-page) .entry-title,
...
.colors-custom .dolphin-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.dolphin-front-page .panel-content .recent-posts article,
...
.colors-custom.dolphin-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'dolphin_custom_colors_css', $css, $hue, $saturation );
}
